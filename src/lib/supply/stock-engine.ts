...
export async function getStockBalances(
  ...
  const rows = await db
    .select({
      ...
      itemItemCode: supplyItems.itemCode,
      itemImageUrl: supplyItems.imageUrl,
      itemItemType: supplyItems.itemType,
      itemBrand: supplyItems.brand,
      itemModel: supplyItems.model,
      itemSerialNumber: supplyItems.serialNumber,
      itemBarcode: supplyItems.barcode,
      itemDetails: supplyItems.details,
      itemPurchasedAt: supplyItems.purchasedAt,
      itemWarrantyExpiresAt: supplyItems.warrantyExpiresAt,
      itemPackSize: supplyItems.packSize,
      itemBorrowLimit: supplyItems.borrowLimit,
  ...
  return rows.map((row) => {
    ...
    return {
      item: {
        ...
        brand: row.itemBrand,
        model: row.itemModel,
        serialNumber: row.itemSerialNumber,
        barcode: row.itemBarcode,
        details: row.itemDetails,
        purchasedAt: row.itemPurchasedAt,
        warrantyExpiresAt: row.itemWarrantyExpiresAt,
        packSize: row.itemPackSize,
        borrowLimit: row.itemBorrowLimit,
